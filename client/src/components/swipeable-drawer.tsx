...
export function SwipeableDrawer({ 
  ...
  return (
    ...
    >
      <div 
        ref={drawerRef}
        className={`absolute left-0 top-0 h-full ${width} bg-background glass-strong dark:border-r-white/10 border-r px-4 pb-4 flex flex-col touch-pan-y safe-area-top ${
