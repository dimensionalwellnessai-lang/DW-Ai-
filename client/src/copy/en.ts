...
export const COPY = {
  ...
  quickSetup: {
    ...
    step1Title: "What's your typical schedule?",
    ...
    schedules: {
      ...
      mixed: "Mixed / varies",
      rebuilding: "Rebuilding my routine",
    },
    step2Title: "When are your busiest days?",
    step2Helper: "Optional — tap any that apply.",
    step3Title: "When do you wake up and wind down?",
    step3Helper: "Approximate is fine.",
    wakeLabel: "I usually wake up around",
    windDownLabel: "I start winding down around",
    step4Title: "Pick one area to start with",
    step4Helper: "We'll set up something small to begin.",
    focusAreas: {
      body: "Body & Movement",
      food: "Food & Nutrition",
      mind: "Mind & Clarity",
      money: "Money & Finances",
      spirit: "Spirit & Meaning",
      work: "School / Work",
    },
