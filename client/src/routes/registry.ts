...
export const ROUTE_REGISTRY: RouteRegistryItem[] = [
  ...
  {
    id: "life-dimensions",
    path: "/life-dimensions",
    label: "Life Dimensions",
    navLabel: "Dimensions",
    icon: "layers",
    type: "page",
    description: "All 8 life dimensions — insights, advice, and cross-dimensional patterns",
    showInMenu: true,
    menuSection: "primary",
    menuOrder: 2,
    enabled: true,
  ...
  {
    id: "energy-transmutation",
    path: "/energy-transmutation",
    label: "Energy Transmutation",
    icon: "sparkles",
    type: "page",
  ...
  },
  {
    ...
    icon: "compass",
    type: "page",
    description: "Unified wellness feed",
    showInMenu: false,
    menuSection: "bottom",
    menuOrder: 54,
    enabled: true,
  },
  {
    ...
    icon: "compass",
    type: "page",
    description: "Legacy alias for the unified feed",
    showInMenu: false, // In bottom nav
    menuSection: "bottom",
    menuOrder: 55,
    enabled: true,
  ...
  },
  {
    ...
    icon: "messageSquare",
    type: "page",
    description: "ChatGPT imports & continuations",
    showInMenu: false,
    enabled: true,
  },
  {
    ...
    icon: "upload",
    type: "page",
    description: "Bring in a ChatGPT export or paste",
    showInMenu: false,
    enabled: true,
  },
  {
